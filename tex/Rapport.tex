...
\lstdefinestyle{inlined}{backgroundcolor=\color[HTML]{2B2B2B}, 
    basicstyle=\ttfamily\color[HTML]{A9B7C6},  
    commentstyle=\color[HTML]{808080},
    keywordstyle=\color[HTML]{CC7832},
    otherkeywords={self},
...
\lstinputlisting[language=Python, style=darkula]{../dmin.py}

L'utilisation se résumera aux lignes de code suivante:

\begin{lstlisting}[language=Python, style=darkula]
